...
export type LaunchListQuery = (
  ...
  & { launchesPast?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'id' | 'mission_name' | 'launch_date_utc' | 'launch_year' | 'launch_success' | 'details'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
...
export type YearDetailsQueryVariables = Exact<{
  year: Scalars['String'];
}>;


export type YearDetailsQuery = (
  { __typename?: 'Query' }
  & { launchesPast?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
...
export const LaunchListDocument = gql`
    query launchList($limit: Int!, $year: String) {
  launchesPast(limit: $limit, find: {launch_year: $year}) {
    id
    mission_name
    links {
      flickr_images
...
export const YearDetailsDocument = gql`
    query yearDetails($year: String!) {
  ...
  export class YearDetailsGQL extends Apollo.Query<YearDetailsQuery, YearDetailsQueryVariables> {
    document = YearDetailsDocument;
